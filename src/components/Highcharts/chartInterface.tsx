            ...
            series: [
              {
                ...
                data: response.incoming.map((data, i) => {
                  return [data[0], ((data[1] / Math.pow(1000, props.length)))]
                })
              },
              {
      ...
      try {
        if (response) {
          ...
          Highcharts.chart("container-" + props.deviceName + "-" + props.interfaceName, {
            ...
            series: [
              { name: "Incoming Errors", data: response.incoming_errors },
              { name: "Outgoing Errors", data: response.outgoing_errors },
              { name: "Incoming Discards", data: response.incoming_errors_discard },
              { name: "Outgoing Discards", data: response.outgoing_errors_discard },
            ],
            credits: {
              enabled: false,
            },
