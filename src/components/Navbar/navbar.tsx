...
const Navbar = () => {
    return (
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 bg-blue-100">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                <Link href="/Dashboard/Dashboard" className="flex">
                ...
                <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white">Lets See</span>
                ...
                <div className="user-profile relative w-full md:block md:w-auto text-4xl cursor-pointer" id="mobile-menu">
                    <div className="border-2 border-black bg-gray-200 rounded-full w-fit overflow-hidden ">
                        <Link href="/Login/Login">
                            <AiOutlineUser />
                        </Link>
                    </div>
                    {/* <div className="user-profile-menu py-1 absolute w-[200px] flex-col bg-white drop-shadow-lg">
                            Logout
                        <Link href="/Dashboard/Dashboard.page" className="flex text-black text-sm pl-3">
                            Logout
                        </Link>
                    </div> */}
                </div>
